            ...
            <div className={styles.glasses}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.63 42.68">
                    <g>
                        <g>
                            <rect
                                className={`${styles.coloredLine} border`}  // To use both global and local css
                                x="30.08"
                                y="11.04"
                                width="2.54"
                                height="15.01"
                            ...
                            />
                            <rect
                                className={[styles.coloredLine, 'border'].join(' ')}  //using Array
                                x="82.73"
                                y="6.54"
                                width="2.53"
                                height="12.68"
                            ...
                            />
                            <path
                                style={{ fill: glassColor }}      //inline css
